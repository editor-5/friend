...
for (let _ = 0; _ < 1; _++) {
  logOutput(JSON.stringify(data[findIndex(data, g)]));
  logOutput(JSON.stringify(data[findIndex(data, g)]));
  logOutput(JSON.stringify(data[findIndex(data, h)]));
  logOutput(JSON.stringify(data[findIndex(data, h)]));
  logOutput(JSON.stringify(data[findIndex(data, i)]));
  logOutput(JSON.stringify(data[findIndex(data, i)]));
}
...
for (let _ = 0; _ < 1; _++) {
  ...
  logOutput(JSON.stringify(data[findIndex(data, g)]));
  logOutput(JSON.stringify(data[findIndex(data, g)]));
  logOutput(JSON.stringify(data[findIndex(data, e)]));
  logOutput(JSON.stringify(data[findIndex(data, d)]));
  logOutput(JSON.stringify(data[findIndex(data, e)]));
  logOutput(JSON.stringify(data[findIndex(data, i)]));
  logOutput(JSON.stringify(data[findIndex(data, i)]));
  logOutput(JSON.stringify(data[findIndex(data, g)]));
